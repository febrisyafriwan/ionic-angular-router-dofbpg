...
/**
 * Generated class for the ContestAdditionalApiPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-contest-additional-api',
  templateUrl: 'contest-additional-api.html',
})
export class ContestAdditionalApiPage {
  ...
  ionViewDidLoad() {
    ...
    this.downloadTemplateLink = this.urlServices.admin+"/contests/contests/result/download/additional_api";
  }
    ...
    this.storage.get('Authorization').then((Authorization) => {
      this.storage.get('username').then((username) => {
        ...
        if(this.fileUpload.nativeElement.value == ""){
          ...
          this.showLoading()
          this.contestProvider.insertAdditionaApi(body, Authorization).subscribe((res: any) => {
